...
def main():
    ...
    step4(word_embedding)  : window_size[int], negative_sampling[int]
    ...
    # distint_value_length = len(dbscan_model.cluster_centers_)
    """ DBSCAN builder """
    ...
    embedding_table = word_embedding(total_sequence,distint_value_length)
